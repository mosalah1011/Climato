...
const uint16_t AVERAGE_BUFFER_SIZE = 16;
...
MovingAverageFloat <AVERAGE_BUFFER_SIZE> movA_Humidite;
MovingAverageFloat <AVERAGE_BUFFER_SIZE> movA_Luminosite;
MovingAverageFloat <AVERAGE_BUFFER_SIZE> movA_Pression;
MovingAverageFloat <AVERAGE_BUFFER_SIZE> movA_Temperature;
...
const int nombre_de_lecture = 300;
//================================================================================================================================
//                                                   Décodeur
//================================================================================================================================
...
#define TIME_TO_SLEEP  1              //Temps pendant lequel l'ESP32 sera en Deep Sleep (en minutes)
...
float vitesseVent = 0;
float vitesse = 0;
int tempsDernierIRQ_Vent = 0, tempsDepuisDernierIRQ_Vent = 0;
...
float moyenneVin_Girouette = 0;                    
float Vin_girouette = 0;
float vinCoeff = 0;
String orientation ;
//================================================================================================================================
//                                                Capteur d'humidité
...
RTC_DATA_ATTR volatile float pluie_24H = 0;
RTC_DATA_ATTR volatile float pluie_H = 0;
...
#include "SD.h"
String donnees_SD = "";
String labelsDonnees_SD = "Date;Heure;Temperature;Humidite;Pression;luminauter;vitesse;direction;pluie_h;pluie_24h;distance;inclinaison_x;inclinaison_y;latitude;longitude;Altitude;Vin\r\n";
//================================================================================================================================
...
#include "credentials.h"              //Onglet pour la connection au Wifi
